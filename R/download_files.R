...
setup_nhanes <- function(data_dir = NULL, yr = 2011){
    ...
    if(!yr %in% seq(1999, 2019, 2)) stop("first year must be an odd number from 1999 to 2013")
    ...
    output <- list(wave = yr, death_url = death_url, target_dir = target_dir, years = diryears)
